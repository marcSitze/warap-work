...
const initialJobPosts = [
  {
    ...
    description:
      "Looking for someone to help with regular garden maintenance including mowing, weeding, and pruning.",
  ...
  },
  {
    ...
    description:
      "Need an experienced painter to paint the interior of a 2-bedroom apartment. Materials provided.",
    location: "Queens, NY",
    rate: "$200/day",
    type: "One-time",
...
export default function ProfilePage({ lang, dictionary }: { lang: LocaleType, dictionary: Awaited<ReturnType<typeof getDictionary>>["products"]; }) {
  ...
  console.log("DICT: ", dictionary.cart);
  ...
  const handleEditJob = (editedJob: any) => {
    setJobPosts(
      jobPosts.map((job) => (job.id === editedJob.id ? editedJob : job))
    );
  };
            ...
            <Card>
              ...
              <CardContent className="flex flex-col items-center">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p>Jobs posted: {(data?.requests || []).length}</p>
